...
<<<<<<<< HEAD:BlindIdea.Infrastructure/Migrations/20260407172615_siu.Designer.cs
    [Migration("20260407172615_siu")]
    partial class siu
========
    [Migration("20260407120314_su")]
    partial class su
>>>>>>>> a218c79 (Enhance production readiness, config, and observability):BlindIdea.Infrastructure/Migrations/20260407120314_su.Designer.cs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlindIdea.Domain.Entities.Rating", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("BlindIdea.Domain.Entities.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlindIdea.Domain.Entities.Rating", b =>
                {
                    b.HasOne("BlindIdea.Domain.Entities.Idea", "Idea")
                        .WithMany("Ratings")
            ...
            modelBuilder.Entity("BlindIdea.Domain.Entities.Team", b =>
                {
                    b.HasOne("BlindIdea.Domain.Entities.ApplicationUser", "Admin")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BlindIdea.Domain.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
